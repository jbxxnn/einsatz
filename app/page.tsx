...
import { PhoneCall, Calendar, Shield, Users, Clock, Star, CheckCircle, MapPin } from "lucide-react"
        ...
        <div className="container mx-auto px-4">
          ...
          {/* <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="flex items-center gap-4 p-6 rounded-lg bg-white shadow-sm">
              ...
              <div>
                <h3 className="text-xl font-semibold">{t("home.whyEinsatz.trustElements.freelancers.title")}</h3>
                <p className="text-muted-foreground">{t("home.whyEinsatz.trustElements.freelancers.description")}</p>
              </div>
            </div>
            <div className="flex items-center gap-4 p-6 rounded-lg bg-white shadow-sm">
              <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center">
              ...
              <div>
                <h3 className="text-xl font-semibold">{t("home.whyEinsatz.trustElements.availability.title")}</h3>
                <p className="text-muted-foreground">{t("home.whyEinsatz.trustElements.availability.description")}</p>
              </div>
            </div>
            <div className="flex items-center gap-4 p-6 rounded-lg bg-white shadow-sm">
              <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center">
              ...
              <div>
                <h3 className="text-xl font-semibold">{t("home.whyEinsatz.trustElements.satisfaction.title")}</h3>
                <p className="text-muted-foreground">{t("home.whyEinsatz.trustElements.satisfaction.description")}</p>
              </div>
            </div>
          </div> */}

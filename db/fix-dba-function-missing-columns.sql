...
SECURITY DEFINER  -- This makes the function run with the owner's privileges, not the caller's
...
BEGIN
  ...
  -- This now runs with SECURITY DEFINER privileges so it can read the table
